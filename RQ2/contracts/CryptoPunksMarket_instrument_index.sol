...
contract CryptoPunksMarket {
    ...
    uint256 public constant totalSupply = 1; // set punk total supply to 1

    uint public nextPunkIndexToAssign = 0;

    bool public allPunksAssigned = false;
    uint public punksRemainingToAssign = 1;
    ...
    function CryptoPunksMarket() payable {
        ...
        owner = msg.sender;
        // totalSupply = 1;                        // Update total supply // set allowed punk number to be one.
